# Створити програму-калькулятор у вигляді класу та кілька методів,
# як мінімум додавання, віднімання, ділення, множення, зведення в
# ступінь та вилучення квадратного кореня.
# Обернути кожен метод у блок try/except і зробити обробку кількох
# винятків, як мінімум ділення на 0.
