...
class TestPerson(unittest.TestCase):
    ...
    def test_str(self):
        self.assertEqual(self.person_1.__str__(),
                         'Иван Петров Сидорович 41 рік, чоловік. Народився: 20.11.1980.')
        self.person_1.sex = 'f'
        self.assertEqual(self.person_1.__str__(),
                         'Иван Петров Сидорович 41 рік, жінка. Народилась: 20.11.1980.')
        self.assertEqual(self.person_2.__str__(),
                         'Tom Black 12 років, чоловік. Народився: 03.05.2010.')
        self.assertEqual(self.person_3.__str__(),
                         'Natali Kid 24 рока, жінка. Народилась: 15.09.1974. Померла: 14.09.1999.')
    ...
    def test_print_age(self):
        self.assertEqual(self.person_1.print_age, '41 рік')
        self.assertEqual(self.person_2.print_age, '12 років')
        self.assertEqual(self.person_3.print_age, '24 рока')
