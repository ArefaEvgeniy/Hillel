# Створити 2 класу truck та car, які є спадкоємцями класу auto з
...
# При цьому об'єкти Truck і Car при створенні можуть приймати такі самі
# аргументи, що об'єкти класу Auto (brand, mark, age - обов'язкові,
# а color і weight - не обов'язкові).
