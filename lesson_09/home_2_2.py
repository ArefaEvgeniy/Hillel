...
# не коректне число: Erdf". Потім у циклі виводиться це повідомлення і цикл
# починається знову чекаючи наступного введення. Функція на вхід приймає рядок
# із введення з вічного циклу. Аналізує її виключно методом .isdigit() та
# іншими методами рядків, без доп.бібліотек і переводить рядок у число, якщо
# це можливо. Функція вміє розпізнавати негативні числа та десяткові дроби,
# а також розпізнає десяткові дроби як з точкою, так і з комою. Функція
# повертає рядок в якому описується яке число введено - негативне або позитивно,
