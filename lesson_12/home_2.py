...
# предыдущего домашнего задания. Объекты класса truck имеют дополнительный
# обязательный атрибут max_load.
...
# обязательного атрибума max_speed. Создать по 2 объекта для каждого из классов
